...
class Assets extends BaseModule
{
	...
	{
		do_action('vlt_fw_register_assets');
	}
	...
	public function frontend_hooks(): void
	{
		...
		do_action('vlt_fw_enqueue_scripts');
		do_action('vlt_fw_enqueue_styles');
	}
	...
	{
		do_action('vlt_fw_admin_enqueue_scripts');
	}
	...
	{
		do_action('vlt_fw_admin_enqueue_styles');
	}
	...
	{
		if (empty($fonts)) {
			$fonts = apply_filters('vlt_fw_google_fonts', []);
		}
	 ...
	 */
	public function preload_google_fonts(): void
	{
	 ...
	 */
	public function move_jquery_to_footer($wp_scripts): void
	{
		if (is_admin()) {
			return;
		}
